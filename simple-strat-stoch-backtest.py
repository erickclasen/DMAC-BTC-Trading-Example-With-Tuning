...
for n in range(0,1):
    while count < 20000:
        count += 1
        master_count += 1
        short_window = random.randint(1,100)
        long_window = random.randint(1,100)
...
#                                                    < signals['long_mavg'][short_window:], 1.0, 0.0)   
        ...
        if total_now > best_bank:
            best_bank = total_now
            print("Master Count, Short Count,Short AVG,Long AVG,Best Bank",master_count,count,short_window,long_window,best_bank)
